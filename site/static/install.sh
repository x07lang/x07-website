...
def main(argv: list[str]) -> int:
    ...
    if args.json:
        ...
        print("")
        print("next: create a project (includes agent kit: AGENT.md + .agent/{docs,skills})")
        print("  mkdir myapp && cd myapp && x07 init")
        print("  x07 run")
        print("  x07 test --manifest tests/tests.json")
        print("")
        print("next: open offline docs / check skills")
        print("  x07up docs path")
        print("  x07up skills status --json")
        print("")
