...
- `x07-wasm-backend` publishes component releases that declare compatibility with
  supported `x07` core versions. (The former `x07-web-ui` and `x07-device-host`
  component repos were archived in the 2026-06 scope cut — see the [roadmap](roadmap.md).)
